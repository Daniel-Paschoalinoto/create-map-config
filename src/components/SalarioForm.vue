    ...
    <div class="form-wrapper">
        ...
        <div class="form-container">
            <div class="form-inputs">
                ...
                <input v-model="form.default" type="text" class="input" placeholder="Insira o default"
                    @input="emitUpdate" />
                <input v-model="form.xpath" type="text" class="input" placeholder="Insira o xpath"
                    @input="emitUpdate" />
